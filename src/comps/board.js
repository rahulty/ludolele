...
function Rectangles() {
    return (
        <>
            ...
            <g class="stars">
                <polygon class="st12" points="173.1,104.5 167.3,101.3 161.5,104.2 162.7,97.8 158.1,93.2 164.6,92.3 167.6,86.5 170.4,92.5 
	176.9,93.5 172.1,98 "/>
                <polygon class="st12" points="293.1,176.8 287.3,173.6 281.5,176.5 282.7,170.1 278.1,165.5 284.6,164.6 287.6,158.8 290.4,164.8 
	296.9,165.8 292.1,170.3 "/>
                <polygon class="st12" points="220.8,296.5 215.1,293.3 209.2,296.2 210.4,289.8 205.8,285.2 212.3,284.3 215.3,278.5 218.1,284.5 
	224.6,285.5 219.8,290 "/>
                <polygon class="st12" points="101.1,224 95.3,220.9 89.5,223.8 90.7,217.4 86.1,212.7 92.6,211.9 95.6,206.1 98.4,212 104.9,213.1 
	100.1,217.6 "/>
            </g>
        </>
    );
